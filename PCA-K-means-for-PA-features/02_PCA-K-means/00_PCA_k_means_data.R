...
# -----------------------------
# > Save 
save(data, file = "E://PC_FIXE//Analysis//02_ARTICLE_2//02_PCA_and_K-MEANS//data//00_data_PCA_k_means.rda")
save(z_data, file = "E://PC_FIXE//Analysis//02_ARTICLE_2//02_PCA_and_K-MEANS//data//00_z_data_PCA_k_means.rda")

save(data_full, file = "E://PC_FIXE//Analysis//02_ARTICLE_2//02_PCA_and_K-MEANS//data//00_data_full_PCA_k_means.rda")
save(z_data_full, file = "E://PC_FIXE//Analysis//02_ARTICLE_2//02_PCA_and_K-MEANS//data//00_z_data_full_PCA_k_means.rda")
